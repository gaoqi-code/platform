...
<div id="container">
    <div class="content memver_c">
        ...
        <div class="c_right">
            <div class="main_nav">发布需求 &gt; 发布成功</div>
            <div class="c_right_content">
                ...
                <div class="s_right">
                    <div class="s_right_content">
                        <p class="title1">需求发布成功！</p>
                        <p class="title2">等待审核，审核通过之后全网审核！</p>
                        <p class="title3">我们将在3个工作日之内审核完成，敬请留意审核结果！</p>
                        <div><a class="layui-btn" href="/member/need/toAdd/0.html">继续发布需求</a>&nbsp;&nbsp;<a href="/member/need/list.html" class="a_blue">管理已发布的需求</a></div>
                    </div>
                </div>
                <div class="clear"></div>
            </div>
